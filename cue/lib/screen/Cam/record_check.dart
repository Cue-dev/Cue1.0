...
class RecordCheckPage extends StatefulWidget {
  ...
  RecordCheckPage({Key key, @required this.originalVideo, @required this.recordVideo})
      : super(key: key);
...
class _RecordCheckPageState extends State<RecordCheckPage> {
  ...
  void initState() {
    ...
    recordcontroller =
        VideoPlayerController.network(widget.recordVideo);
    ...
    controller = new Controller(
      items: [
        PlayerItem(
            title: widget.originalVideo.title, url: widget.recordVideo),
      ],
      autoPlay: true,
